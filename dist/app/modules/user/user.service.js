...
const createUser = (user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (newUserData) {
        newUserData = yield user_model_1.User.findOne({ _id: newUserData._id }).select({
            password: 0,
        });
    }
    return newUserData;
...
const getMyProfile = (requestedUser) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_model_1.User.findById(requestedUser._id).select('-password');
    if (!result) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'User not found!');
    }
    return result;
});
const updateMyProfile = (requestedUser, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield user_model_1.User.findById(requestedUser._id);
    if (!isExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'User not found!');
    }
    ...
    const result = yield user_model_1.User.findByIdAndUpdate(requestedUser._id, updatedStudentData, {
        new: true, // return new document of the DB
    }).select('-password');
    return result;
});
