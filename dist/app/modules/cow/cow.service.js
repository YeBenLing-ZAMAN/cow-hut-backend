...
const updateCow = (id, payload, requestedUser) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield cow_model_1.Cow.findOne({
...
const deleteCow = (id, requestedUser) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield cow_model_1.Cow.findOneAndDelete({
        _id: id,
        seller: requestedUser._id,
    });
    if (!result) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to delete Cow');
    }
    return result;
});
exports.CowService = {
