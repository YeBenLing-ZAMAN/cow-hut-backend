...
const createAdmin = admin =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (newAdminData) {
      newAdminData = yield admin_model_1.Admin.findOne({
...
const getAdminProfile = requestedUser =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield admin_model_1.Admin.findById(requestedUser._id).select(
      '-password'
    )
    if (!result) {
      throw new ApiError_1.default(
...
const updateAdminProfile = (requestedUser, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield admin_model_1.Admin.findByIdAndUpdate(
      requestedUser._id,
      updatedStudentData,
      {
