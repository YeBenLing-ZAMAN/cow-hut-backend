...
router.post(
  '/login',
  validationRequest_1.requestValidation.validateRequest(
    admin_validation_1.AdminValidation.loginAdminZodSchema
  ),
  admin_controller_1.AdminController.adminLogin
)
router.get(
  '/my-profile',
...
router.patch(
  ...
  (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN),
  validationRequest_1.requestValidation.validateRequest(
    admin_validation_1.AdminValidation.AdminProfileZodSchema
  ),
